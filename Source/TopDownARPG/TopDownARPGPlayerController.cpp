...
void ATopDownARPGPlayerController::ActivateAbility1()
{
	...
	UE_LOG(LogTopDownARPG, Error, TEXT("ATopDownARPGPlayerController::ActivateAbility1"));
...
void ATopDownARPGPlayerController::ActivateAbility3()
{
	...
	UE_LOG(LogTopDownARPG, Error, TEXT("ATopDownARPGPlayerController::ActivateAbility3"));
	...
	if (IsValid(Ability))
	{
		...
		UE_LOG(LogTopDownARPG, Error, TEXT("ATopDownARPGPlayerController::ActivateAbility3 IsValid(Ability) == false"));
	}
}
...
void ATopDownARPGPlayerController::ActivateAbility4()
{
	...
	UAbility* Ability = PlayerCharacter->AbilityInstances[3];
	if (IsValid(Ability))
	{
		Ability->Activate(PlayerCharacter);
	}
